...
public class MtsOnlinePaymentTest {
    ...
    @Test
    @Story("Основной функционал")
    @Description("Тестирование блока 'Онлайн пополнение без комиссии' - основные проверки")
    ...
    @Test
    @Story("Проверка форм")
    @Description("Проверка надписей во всех формах оплаты (услуги связи, интернет, рассрочка, задолженность)")
    ...
    @Test
    @Story("Интеграция с платежной системой")
    @Description("Тест проверки перехода на страницу оплаты после нажатия кнопки 'Продолжить'")
    @Severity(SeverityLevel.CRITICAL)
